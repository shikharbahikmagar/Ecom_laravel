        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{ url('/admin/add-edit-banners') }}" class="btn btn-block btn-success" style="max-width: 150px; float: right; display:inline-block;">
                  Add Banner</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="categories" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{ $banner['id'] }}</td>
                  <td> <?php $product_image_path = 'images/front_images/carousel/'.$banner['image']; ?>
                  ...
                  <td>
                    <a href="{{ url('/admin/add-edit-banners/'.$banner['id'] ) }}"><i class="fas fa-edit"></i></a>
                    &nbsp;&nbsp;<a style="color:red;" href="javascript:void(0)" class="confirmDelete" record="banner" recordId="{{  $banner['id'] }}">
